...
try {
    foreach($purchase_orders as $po){
        ...
        // we dont save th data if tis zero received
        if($delivered > 0){
        ...
        //Insert script adding to the order_product_history
            $delivery_history = [
                ...
                $sql = "INSERT INTO 
                    ...
                    //select statement- to pull the current quantity product
                    //update statement- to add the delievered product to the cur quantity
                    $stmt = $conn->prepare("
