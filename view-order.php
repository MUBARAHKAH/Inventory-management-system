             ...
             <div class="column column-12">
                ...
                <div class="section_content">
                    <div class="poListContainers">
                        <?php
                         $stmt = $conn->prepare("
                            SELECT order_product.id,order_product.product, products.product_name, order_product.quantity_ordered, user.first_Name, order_product.batch,
                            order_product.quantity_received, user.last_Name, suppliers.supplier_name, order_product.status, order_product.created_at
                        ...
                        <div class="poList" id="container-<?= $batch_id?>">
                            ...
                            <div class="pOrderUpdateBtnContainer">
                            ...
                            callback: function(toAdd){
                                ...
                                if(toAdd){
                                    ...
                                    for(i=0; i < qtyDeliveredList.length; i++){
                                        poListsArrForm.push({
                                            qtyRecieve: qtyReceivedList[i].innerText,
                    ...
                    $.get('database/view-delivery-history.php', {id: id}, function(data){
                        if(data.length){
                                ...
                                data.forEach((row, id) => {
                                 ...
                                 deliveryHistoryHtml ='<table class="deliveryHistroyTable">\
                                <thead>\
                                <tr>\
                                <th>#</th>\
                                <th>Date Received</th>\
